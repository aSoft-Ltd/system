...
class MemoryUnitConvertor {
    ...
    @Test
    fun should_show_10MB_correctly() {
        val size = MemorySize(value = 10174706.0, multiplier = Multiplier.Unit, unit = MemoryUnit.Bytes)
        expect(size.toBestSize().toString()).toBe("9.7 MB")
    }
}